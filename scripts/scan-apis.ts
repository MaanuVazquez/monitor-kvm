import { connect } from "../src/modules/webos/index.ts";
...
const READ_ENDPOINTS: {
  ...
  {
    name: "config/getConfigs (brightness)",
    uri: "ssap://config/getConfigs",
    payload: { configNames: ["com.palm.brightness"] },
  },
  {
    name: "settings/getSystemSettings",
    uri: "ssap://settings/getSystemSettings",
  },
  {
    name: "settings/getSystemSettings (picture)",
    uri: "ssap://settings/getSystemSettings",
    payload: { category: "picture", keys: ["brightness"] },
  },
  {
    name: "settings/getSystemSettings (sound)",
    uri: "ssap://settings/getSystemSettings",
    payload: { category: "sound", keys: ["soundMode"] },
  },
  {
    name: "externalpq/getExternalPqSettings",
    uri: "ssap://externalpq/getExternalPqSettings",
  },
  {
    name: "externalpq/getExternalPqData",
